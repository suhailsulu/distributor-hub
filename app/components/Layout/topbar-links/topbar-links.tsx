  ...
  return (
    <div className="relative user-icon-topbar z-50">
      <button
        ...
        onClick={toggleLinks}
        title="User menu"
        className="rounded-full bg-gray-200 p-2 text-gray-600 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 cursor-pointer"
      >
          ...
          <div className="absolute right-0 z-50 mt-2 min-w-30 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
            <div className="flex flex-col items-center gap-4 p-2">
              {isRoot && (
                <Link
                  href="/dashboard"
                  className="text-sm text-[#1a2f4c] hover:text-[#1377c5]"
                >
                  Dashboard
                </Link>
              )}
              ...
              <div
                ...
                className="text-sm text-[#1a2f4c] hover:text-[#1377c5] cursor-pointer"
              >
                Logout
              </div>
            </div>
