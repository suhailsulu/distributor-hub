...
export function OTPEmailTemplate({ email, otp }: EmailTemplateProps) {
  return (
    ...
    >
      <p>Hello {email},</p>
      <p>
        We received a request to verify your account. Use the code below to
        proceed:
      </p>
      <p>
      ...
      <p>
        Security notice: Never share this code with anyone. We will never ask
        for your OTP via email or phone.
      </p>
    </EmailLayout>
  );
}
