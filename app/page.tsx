        ...
        <div className="grid w-full gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-6 max-w-4xl text-4xl font-bold leading-tight text-[#10253d] sm:text-5xl lg:text-6xl">
              A secure asset-sharing platform for distributor networks in a
              large pharma ecosystem.
            </h1>

            <p className="mt-6 max-w-3xl text-lg leading-8 text-[#466a91] sm:text-xl">
              Distributor Hub helps a large pharmaceutical company share
              documents, links, and other business assets with the distributor
              companies connected to it. Each distributor can have a different
              set of approved resources based on its role, access level, and
              business needs.
            </p>
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-3">
              {featureCards.map((card) => (
                ...
                >
                  <h2 className="text-base font-semibold text-[#17314d]">
                    {card.title}
                  </h2>
                  <p className="mt-2 text-sm leading-6 text-[#5b7899]">
                    {card.description}
                  </p>
                </article>
              ))}
          ...
          <aside className="rounded-[2rem] border border-[#d3e0ec] bg-[#10253d] p-7 text-white shadow-[0_24px_50px_rgba(16,37,61,0.22)] sm:p-8">
            <p className="text-sm font-semibold uppercase tracking-[0.22em] text-[#85c9f3]">
              How It Works
            </p>
            <div className="mt-6 space-y-5">
              <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
                ...
                <h3 className="mt-2 text-lg font-semibold">
                  Central company manages assets
                </h3>
                <p className="mt-2 text-sm leading-6 text-[#c6d8e9]">
                  Corporate teams upload and organize documents, commercial
                  links, training material, and reference assets in one place.
                </p>
              </div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
                <p className="text-sm font-semibold text-[#9ed8fb]">02</p>
                <h3 className="mt-2 text-lg font-semibold">
                  Access is assigned per distributor
                </h3>
                <p className="mt-2 text-sm leading-6 text-[#c6d8e9]">
                  Different distributor companies can receive different
                  collections of assets depending on geography, product scope,
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
                ...
                <h3 className="mt-2 text-lg font-semibold">
                  Partners access the right resources faster
                </h3>
                <p className="mt-2 text-sm leading-6 text-[#c6d8e9]">
                  Approved users sign in and retrieve the exact assets they need
                  without waiting for manual sharing or repeated email requests.
                </p>
              </div>
            </div>
          </aside>
